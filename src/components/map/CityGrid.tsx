        ...
        >
          <div>
            ...
            <p className="text-sm text-gray-500">
              Bengaluru • {city.id * 7 + 20} reviews
            </p>
            <p className="text-xs text-orange-500 mt-1 flex items-center">
              ⚠️ Weakest:{" "}
              <span className="font-semibold ml-1">Childcare Access</span>
            </p>
          </div>
          <div
            className={`px-3 py-1 rounded-lg text-white font-bold ${city.score >= 3.5 ? "bg-green-500" : "bg-yellow-500"}`}
          >
            {city.score}
          </div>
        </div>
